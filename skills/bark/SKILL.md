...
2. **Add context** the agent will need. The user's description will be rough, so fill in what you can, but keep it concise for the agent. Context can include:
...
>
> **Background:** This is a quick handoff from a rapid iteration session. The description is intentionally light, so you need to orient yourself first:
